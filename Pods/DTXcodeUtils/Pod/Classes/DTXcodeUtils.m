...
@implementation DVTSourceTextView

- (__nullable NSString *)selectedString {
  NSRange selectedRange = [self selectedRange];
  if (selectedRange.location == 0) {
    return nil;
  }
  return [self.textStorage.string substringWithRange:selectedRange];
}

@end

@implementation DVTCompletingTextView
@end
